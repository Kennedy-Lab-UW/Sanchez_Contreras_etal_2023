...
fig.savefig('figures/Figure_6_Figure_Supplement_3.png', dpi=600, facecolor='white',
            bbox_inches='tight')
fig.savefig('figures/Figure_6_Figure_Supplement_3.pdf', dpi=600, facecolor='white',
            bbox_inches='tight')
