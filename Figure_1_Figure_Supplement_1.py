...
if __name__ == "__main__":
    ...
    for index, tissue in enumerate(tissue_type[:-1]):
        ...
        if not os.path.isfile("data/imported_data/Figure_1_Figure_Supplement_1_" + tissue_type_abbrev[index] + "_depth_data.csv"):
            if not os.path.isdir("data/stats/"):
                os.mkdir("data/stats/")

            depth_df = calc_depth_plot_data(young_mouse_id,
                                            tissue,
                                            "data/imported_data/Figure_1_Figure_Supplement_1_" + tissue_type_abbrev[index] + "_depth_data.csv")
        else:
    ...
    fig.savefig('figures/Figure_1_Figure_Supplement_1.png', dpi=600, facecolor='white', 
                bbox_inches='tight')
    fig.savefig('figures/Figure_1_Figure_Supplement_1.pdf', dpi=600, facecolor='white', 
                bbox_inches='tight')
