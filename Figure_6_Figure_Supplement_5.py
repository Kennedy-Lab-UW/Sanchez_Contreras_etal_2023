...
if __name__ == '__main__':
    ...
    fig.savefig("figures/Figure_6_Figure_Supplement_5.png", facecolor='white', dpi=600)
    fig.savefig("figures/Figure_6_Figure_Supplement_5.pdf", facecolor='white', dpi=600)
