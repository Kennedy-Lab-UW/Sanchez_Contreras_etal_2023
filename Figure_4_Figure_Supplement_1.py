...
fig.savefig("figures/Figure_4_Figure_Supplement_1.png", facecolor='white', dpi=600)
fig.savefig("figures/Figure_4_Figure_Supplement_1.pdf", facecolor='white', dpi=600)
